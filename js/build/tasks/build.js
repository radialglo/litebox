/**
 * @file build script for litebox-app.js that cleans up amd definitions adapted from jQuery build
...
module.exports = function(grunt) {
    ...
    function convert(name, path, contents) {
        ...
        // Ignore litebox-app's exports because this is the mainfile
        if ( name !== "litebox-app" ) {
                contents = contents
